...
class ContactUsViewController: UIViewController {
    ...
    @IBAction func doneButtonnPressed(_ sender: Any) {
        ...
        let originatingNavController = LibraryAPI.sharedInstance.getOriginatingNavVC()
        let controller = storyboard.instantiateViewController(withIdentifier: originatingNavController) as UIViewController
